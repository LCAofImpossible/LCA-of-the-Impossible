...
def validate(
    ...
    lab_contract = {
        "impossible-lab.html": (
            ...
            'data-daily-entry',
            'data-lab-difficulty',
            "assets/lab-hub.css?v=20260915-relics1",
            "assets/lab-progress.js?v=20260915-relics1",
            "assets/lab-difficulty.js?v=20260915-relics1",
            "assets/daily.js?v=20260911-daily1",
            "assets/lab-hub.js?v=20260915-relics1",
        ),
        "lab-daily.html": (
            'data-lab-daily',
        ...
        "impossible-lab-run.html": (
            'data-lab-run-page',
            "Six games.<br><span>One run.</span>",
            "Run Score",
            'data-run-total',
            'data-run-stages',
            'data-run-start',
            ...
            "assets/lab.css?v=20260915-relics1",
            "assets/lab-run.css?v=20260915-relics1",
            "assets/lab-progress.js?v=20260915-relics1",
            "assets/lab-difficulty.js?v=20260915-relics1",
            "assets/lab-run.js?v=20260915-relics1",
            "assets/lab-run-page.js?v=20260915-relics1",
        ),
        "lab.html": (
            ...
            'id="lab-game-area"',
            "assets/lab.css?v=20260915-relics1",
            "assets/lab-nav.js?v=20260915-relics1",
            "assets/lab-actions.js?v=20260915-relics1",
            "assets/lab-progress.js?v=20260915-relics1",
            "assets/lab-difficulty.js?v=20260915-relics1",
            "assets/lab-run.js?v=20260915-relics1",
            "assets/lab-results.js?v=20260915-relics1",
        ...
        "lab-crossword.html": (
            ...
            'id="crossword-replay"',
            'class="lab-route-bar"',
            "EXPERIMENT 02 OF 06 · CURRENT GAME",
            'data-lab-another',
            'data-lab-result-scorecard',
            'data-lab-difficulty',
            'id="lab-game-area"',
        ...
        "lab-alphabet.html": (
            ...
            'id="alphabet-result"',
            'class="lab-route-bar"',
            "EXPERIMENT 03 OF 06 · CURRENT GAME",
            'data-lab-another',
            'data-lab-result-scorecard',
        ...
        "lab-timeline.html": (
            "IMPOSSIBLE LAB · EXPERIMENT 05",
            "Impossible <span>Timeline.</span>",
            'id="timeline-list"',
            'id="timeline-submit"',
            'id="timeline-reveal-list"',
            'id="timeline-final"',
            "EXPERIMENT 05 OF 06 · CURRENT GAME",
            'data-lab-another',
            'data-lab-result-scorecard',
            'data-lab-difficulty',
            'id="lab-game-area"',
        ...
        "lab-relics.html": (
            "IMPOSSIBLE LAB · EXPERIMENT 06",
            "Impossible <span>Relics.</span>",
            'id="relics-board"',
            'id="relics-hint"',
            'id="relics-final"',
            "EXPERIMENT 06 OF 06 · CURRENT GAME",
            'data-lab-another',
            'data-lab-result-scorecard',
            'data-lab-difficulty',
            'id="lab-game-area"',
        ...
        "assets/lab-hub.js": (
            ...
            "difficultySystem?.clearRecords()",
            "difficultySystem?.withLevel",
        ),
        "assets/lab-hub.css": (
            ".lab-hub-actions",
            ".lab-hub-grid",
        ...
        "assets/lab-actions.js": (
            ...
            "game.id !== currentGame",
            "game.status === 'live'",
            "ImpossibleLabDifficulty?.withLevel",
        ...
        "assets/lab-results.js": (
            ...
            "metric('Completion'",
            "metric('Accuracy'",
            "environmental results are never compared",
            "difficultySystem?.record",
            "PERSONAL BEST",
            "Best ${levelDetail.label}",
            "Lab Score",
        ...
        "assets/lab-difficulty.js": (
            ...
            "targetWords: 8",
            "targetWords: 12",
            "letters: 12, seconds: 300",
            "letters: 18, seconds: 120, passLimit: 3",
            "spins: 20, solveAttempts: 5",
            "spins: 10, solveAttempts: 2",
            "cards: 3, rounds: 4",
            "cards: 5, rounds: 5",
            "pairs: 4, hints: 2",
            "pairs: 8, hints: 0",
            "isRunMode() ? DEFAULT_LEVEL",
            "level === DEFAULT_LEVEL",
            "progressSystem?.record",
            "withPlayTarget",
            "input.addEventListener('click'",
            "document.body.dataset.labDifficultyLevel",
            "querySelectorAll?.('[data-lab-difficulty]')",
            "clearRecords",
        ),
        "assets/lab-run.js": (
        ...
        "assets/timeline.js": (
            ...
            "fetch('timeline.json'",
            "difficultySystem?.config('timeline')",
            "chooseCloseSet",
            "entry.episode.url",
        ...
        "assets/relics.js": (
            ...
            "fetch('episodes.json'",
            "fetch('crossword.json'",
            "difficultySystem?.config('relics')",
            "window.ImpossibleLabResults?.render",
        ),
        "assets/relics.css": (
            ".relics-workspace",
    ...
    crossword_runtime = "\n".join(
        ...
        for path in ("assets/crossword.js", "assets/alphabet.js", "assets/spin.js", "assets/relics.js", "assets/lab-nav.js", "assets/lab-actions.js", "assets/lab-results.js", "assets/lab-hub.js")
    )
    ...
    difficulty_runtime = downloaded.get("assets/lab-difficulty.js", b"").decode("utf-8", errors="replace")
    for forbidden in ("document.cookie", "sessionStorage", "innerHTML", "fetch(", "XMLHttpRequest"):
        if forbidden in difficulty_runtime:
            errors.append(f"Lab difficulty runtime violates its local-only privacy contract with {forbidden!r}")
    ...
    try:
        ...
        if any(game_status.get(game) != "live" for game in ("guess", "crossword", "alphabet", "spin", "timeline", "relics")):
            errors.append("All six live Impossible Lab experiments are not registered")
        for game in game_registry.get("games", []):
    ...
    if sitemap.count("/lab-timeline.html") != 1:
        errors.append("Impossible Timeline does not occur exactly once in the live sitemap")
    if sitemap.count("/lab-relics.html") != 1:
