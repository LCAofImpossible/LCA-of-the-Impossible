...
def validate(
    ...
    lab_contract = {
        "impossible-lab.html": (
            ...
            'data-daily-entry',
            'data-lab-difficulty',
            "assets/lab-hub.css?v=20260912-timeline1",
            "assets/lab-progress.js?v=20260912-timeline1",
            "assets/lab-difficulty.js?v=20260912-timeline1",
            "assets/daily.js?v=20260911-daily1",
            "assets/lab-hub.js?v=20260912-timeline1",
        ),
        "lab-daily.html": (
            'data-lab-daily',
            ...
            "assets/lab.css?v=20260912-timeline1",
            "assets/daily.css?v=20260911-daily1",
            "assets/daily.js?v=20260911-daily1",
        ),
        "impossible-lab-run.html": (
            'data-lab-run-page',
            "Five games.<br><span>One run.</span>",
            "Run Score",
            'data-run-total',
            'data-run-stages',
            'data-run-start',
            ...
            "assets/lab.css?v=20260912-timeline1",
            "assets/lab-run.css?v=20260912-timeline1",
            "assets/lab-progress.js?v=20260912-timeline1",
            "assets/lab-difficulty.js?v=20260912-timeline1",
            "assets/lab-run.js?v=20260912-timeline1",
            "assets/lab-run-page.js?v=20260912-timeline1",
        ),
        "lab.html": (
            ...
            'id="lab-game-area"',
            "assets/lab.css?v=20260912-timeline1",
            "assets/lab-nav.js?v=20260912-timeline1",
            "assets/lab-actions.js?v=20260912-timeline1",
            "assets/lab-progress.js?v=20260912-timeline1",
            "assets/lab-difficulty.js?v=20260912-timeline1",
            "assets/lab-run.js?v=20260912-timeline1",
            "assets/lab-results.js?v=20260912-timeline1",
        ...
        "lab-alphabet.html": (
            ...
            'id="alphabet-result"',
            'class="lab-route-bar"',
            "EXPERIMENT 03 OF 05 · CURRENT GAME",
            'data-lab-another',
            'data-lab-result-scorecard',
        ...
        "lab-timeline.html": (
            ...
            'id="timeline-final"',
            "EXPERIMENT 05 OF 05 · CURRENT GAME",
            'data-lab-another',
            'data-lab-result-scorecard',
            'data-lab-difficulty',
            'id="lab-game-area"',
            "assets/lab.css?v=20260912-timeline1",
            "assets/timeline.css?v=20260912-timeline1",
            "assets/lab-nav.js?v=20260912-timeline1",
            "assets/lab-actions.js?v=20260912-timeline1",
            "assets/lab-progress.js?v=20260912-timeline1",
            "assets/lab-difficulty.js?v=20260912-timeline1",
            "assets/lab-run.js?v=20260912-timeline1",
            "assets/lab-results.js?v=20260912-timeline1",
            "assets/timeline.js?v=20260912-timeline1",
        ),
        "assets/lab.js": (
            "registry.episodes",
