...
def main() -> int:
    ...
    check_public_page(ROOT / "lab-spin.html", BASE_URL + "lab-spin.html", latest_image, "website", "Game")
    check_public_page(ROOT / "lab-timeline.html", BASE_URL + "lab-timeline.html", latest_image, "website", "Game")
    check_public_page(ROOT / "lab-relics.html", BASE_URL + "lab-relics.html", latest_image, "website", "Game")
    check_public_page(ROOT / "lab-origins.html", BASE_URL + "lab-origins.html", latest_image, "website", "Game")
    check_public_page(ROOT / "lab-ascent.html", BASE_URL + "lab-ascent.html", latest_image, "website", "Game")
    ...
    if errors:
        ...
        return 1
    print(f"SEO QA passed for {len(episodes) + 16} public pages.")
    return 0
