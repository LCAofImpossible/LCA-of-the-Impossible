...
def nav_html(prefix: str, current: str) -> str:
    ...
    lab_current = ' aria-current="page"' if current in {"impossible-lab.html", "impossible-lab-run.html", "lab-daily.html", "lab.html", "lab-crossword.html", "lab-alphabet.html", "lab-spin.html"} else ""
