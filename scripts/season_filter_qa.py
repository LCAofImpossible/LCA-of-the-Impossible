...
def main() -> int:
    ...
    if archive_path.is_file():
        ...
        require_token(archive, 'assets/site.js?v=20260830-subject-descriptions1', "archive.html")

    if index_path.is_file():
        index = index_path.read_text(encoding="utf-8")
        require_token(index, 'href="archive.html?season=season-i"', "index.html")
        require_token(index, 'assets/site.js?v=20260830-subject-descriptions1', "index.html")
